...
def settings():
    print("[SESSION] Initial settings of autotests")


@pytest.fixture(scope="class")
def user():
    print("[CLASS] Create user data one time per test class")


@pytest.fixture
def users_client(settings):
    print("[FUNCTION] Create API client for each autotest")
...
def user_data() -> dict:
    ...
    print("Delete user after test (teardown)")
